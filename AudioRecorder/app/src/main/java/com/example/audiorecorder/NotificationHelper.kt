...
class NotificationHelper(private val context: Context) {
    ...
    fun buildRecordingNotification(elapsedSeconds: Int, bookmarkCount: Int = 0, isPaused: Boolean = false): Notification {
        ...
        return NotificationCompat.Builder(context, CHANNEL_ID)
            .setContentTitle(if (isPaused) "ضبط صدای داخلی متوقف شده" else "در حال ضبط صدای داخلی")
