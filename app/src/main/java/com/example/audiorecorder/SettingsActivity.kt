...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        radioGroup.setOnCheckedChangeListener { _, checkedId ->
            ...
            if ((application as AudioRecorderApp).recordingSession.state.value is RecordingSessionState.Recording ||
                (application as AudioRecorderApp).recordingSession.state.value is RecordingSessionState.Paused) {
